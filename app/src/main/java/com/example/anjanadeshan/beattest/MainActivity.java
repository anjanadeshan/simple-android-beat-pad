package com.example.anjanadeshan.beattest;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  sound1 = sp.load(getApplicationContext(),R.raw.sound1,1);
        sound1 = sp.load(getApplicationContext(),R.raw.kkkk,1);
        //sound2 = sp.load(getApplicationContext(),R.raw.sound2,1);
        sound2 = sp.load(getApplicationContext(),R.raw.chant2,1);
       // sound3 = sp.load(getApplicationContext(),R.raw.sound3,1);
        sound3 = sp.load(getApplicationContext(),R.raw.clap2,1);
        sound4 = sp.load(getApplicationContext(),R.raw.sound4,1);
        sound5 = sp.load(getApplicationContext(),R.raw.coli,1);
        sound6 = sp.load(getApplicationContext(),R.raw.sound6,1);
        sound7 = sp.load(getApplicationContext(),R.raw.tom1,1);
        sound8 = sp.load(getApplicationContext(),R.raw.tom2,1);
